...
# patch the docstring of `pyaragorn` so that we don't show the link to redirect
# to the docs (we don't want to see it when reading the docs already, duh!)
doc_lines = pyaragorn.__doc__.splitlines()
...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/pyaragorn",
    ...
    "switcher": {
        "json_url": "https://pyaragorn.readthedocs.io/en/latest/_static/switcher.json",
...
htmlhelp_basename = pyaragorn.__name__
